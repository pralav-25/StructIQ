...
const paths = {
  ...
  bridge: '<path d="M2 18h20M6 18V5m12 13V5M2 12c6-1 10-4 10-9 0 5 4 8 10 9M10 18v-7m4 7v-7"/>',
  ...
  share: '<circle cx="18" cy="5" r="3"/><circle cx="5" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><path d="m8 10 7-4m-7 8 7 4"/>',
  tool: '<path d="M14 3a6 6 0 0 0-7 8l-5 6 5 5 6-6a6 6 0 0 0 8-7l-4 4-4-4 4-4Z"/>',
};
function icon(name) { return `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${paths[name] || paths.grid}</svg>`; }
...
function brand() { const a = el('a', { class: 'brand', href: '/', 'aria-label': 'StructIQ home' }); a.innerHTML = '<img src="/static/favicon.svg" alt="">Struct<span>IQ</span>'; return a; }
...
function assetTable(assets) {
  ...
  const table = el('table'); table.innerHTML = '<thead><tr><th scope="col">Asset name</th><th scope="col">Type</th><th scope="col">Age</th><th scope="col">Demo health</th><th scope="col">Priority</th><th scope="col"><span class="small">Details</span></th></tr></thead>';
